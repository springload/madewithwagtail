    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "link_email",
                    models.EmailField(
                        help_text=b"Set the recipient email address if you want the link to send an email.",
                        max_length=75,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "link_phone",
                    models.CharField(
                        help_text=b"Set the number if you want the link to dial a phone number.",
                        max_length=20,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "explicit_name",
                    models.CharField(
                        help_text=b"If you want a different name than the page title.",
                        max_length=64,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "short_name",
                    models.CharField(
                        help_text=b"If you need a custom name for responsive devices.",
                        max_length=32,
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "css_class",
                    models.CharField(
                        help_text=b"Optional styling for the menu item",
                        max_length=255,
                        null=True,
                        verbose_name=b"CSS Class",
                        blank=True,
                    ),
                ),
                (
                    "icon_class",
                    models.CharField(
                        help_text=b"In case you need an icon element <i> for the menu item",
                        max_length=255,
                        null=True,
                        verbose_name=b"Icon Class",
                        blank=True,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        related_name="menu_items", to="core.NavigationMenu"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(
                        help_text="The label of the form field", max_length=255
                    ),
                ),
                (
                    "field_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_url",
                    models.URLField(
                        help_text=b'The URL of your site, something like "https://www.springload.co.nz"',
                        null=True,
                        blank=True,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=modelcluster.fields.ParentalKey(
                related_name="form_fields", to="core.SubmitFormPage"
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            name="content_object",
            field=modelcluster.fields.ParentalKey(
                related_name="tagged_items", to="core.WagtailPage"
            ),
            preserve_default=True,
        ),
        migrations.AddField(
